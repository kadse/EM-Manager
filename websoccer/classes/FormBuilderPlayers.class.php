...
class FormBuilderPlayers {
	 ...
	 */
	public static function createFormGroup($i18n, $id, $fieldId, $fieldInfo, $fieldValue, $labelKeyPrefix) {
		$type = $fieldInfo['type'];
		$fieldFormId = $fieldId."_".$id;
		...
		if ($type == 'boolean') {
			...
			echo '<input type=\'checkbox\' value=\'1\' name=\''. $fieldFormId . '\'';
			if ($fieldValue == '1') {
				echo ' checked';
			}
			echo '>';
			...
			switch ($type) {
				...
				case 'textarea':
					...
					echo '<textarea id=\''. $fieldFormId . '\' name=\''. $fieldFormId . '\' wrap=\'virtual\' class=\''. $class .'\' rows=\'10\'>'. $fieldValue .'</textarea>';
					break;
				...
				case 'timestamp':
					...
					echo '<input type=\'text\' name=\''. $fieldFormId . '_date\' value=\''. date($dateFormat, $fieldValue) . '\' class=\'input-small\'>';
					echo '<span class=\'add-on\'><i class=\'icon-calendar\'></i></span>';
					echo '</div>';
					echo '<div class=\'input-append bootstrap-timepicker\'>';
					echo '<input type=\'text\' name=\''. $fieldFormId . '_time\' value=\''. date('H:i', $fieldValue) . '\' class=\'timepicker input-small\'>';
				...
				case 'select':
					echo '<select id=\''. $fieldFormId . '\' name=\''. $fieldFormId . '\'>';
				...
				default:
					if (isset($fieldInfo['readonly']) && $fieldInfo['readonly']) {
						...
						echo '<input type=\''. $htmlType . '\' id=\''. $fieldFormId . '\' '. $additionalAttrs . 'name=\''. $fieldFormId . '\' value=\'';
	 ...
	 */
	public static function validateField($i18n, $id, $fieldId, $fieldInfo, $fieldValue, $labelKeyPrefix) {
